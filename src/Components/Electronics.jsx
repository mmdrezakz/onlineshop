...
export default function Electronics({electronicItem}) {
    return (
        <>
<div className="flex flex-col divide-y divide-gray-400">
          <h3 className='mx-2 my-5 font-extrabold md:text-2xl'>ELECTRONIC</h3>
...
<SwiperSlide  key={item.id}>
                ...
                <div className='flex justify-center items-center bg-[#e6e5e5] rounded-2xl w-40 md:w-44 h-40 md:h-56 font-extrabold text-green-500 underline cursor-pointer'>
                   <Link to={"/shop/electronic"}>SHOW ALL</Link>
                </div>
            </SwiperSlide>
            </Swiper>
        </div>
